CREATE OR REPLACE FUNCTION distancia_jugadores (primer_jugador real[], segundo_jugador real[]) RETURNS real AS
$$
DECLARE
...
BEGIN
	...
	-- (el array está rellenado con ponderaciones valor 1)
...
-- probar la funcion:
select distancia_jugadores('{31,1,75,55,65,55,80,50,55,15,50,45,55,65,40,40,55,40,55,50,55,35,15,65,75,40,60,50,45,65,20,65,60,70,60,50,55,22.85,100,40,5,5,60,50,5,70,5,100,50,85,5,5,5,5,5}',
